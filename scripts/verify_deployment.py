#!/usr/bin/env python3
"""Fail if the Studio Dev deployment no longer matches contracts/ClauseWatch.py."""
...
ADDRESS = "0x0B32c2f2aFbbf79963D9132f93912694e913bA6d"
SOURCE = pathlib.Path(__file__).resolve().parents[1] / "contracts" / "ClauseWatch.py"
...
def on_chain_hash() -> str:
    ...
    headers = {"content-type": "application/json", "user-agent": "clausewatch-ci/1.0"}
